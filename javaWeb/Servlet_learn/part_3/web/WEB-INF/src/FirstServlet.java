 ...
 *         > 1. 获取当前WEB应用的初始化参数: servletConfig.getServletContext().getInitParameterNames()
 *         > 2. 获取当前WEB应用的某个文件的绝对路径，部署后的路径: servletConfig.getServletContext().getRealPath(String path)
 *         > 3. 获取当前WEb应用的名称: servletConfig.getServletContext().getContextPath()
 *         > 4. 获取当前WEB应用的某个文件的输入流：  servletConfig.getServletContext().getClassLoader().getResourceAsStream(String path)
 *
 */
public class FirstServlet implements Servlet {
    ...
    public void init(ServletConfig servletConfig) throws ServletException {
        ...
        // 获取ServletContext对象
        System.out.println("获取ServletContext对象");
        ...
        // 获取当前WEB应用的某个文件路径
        String realPath = context.getRealPath("/dh.png");
        // D:\JAVA\lEARN\idea_learn\javaWeb\Servlet_learn\part_3\web\dh.png
        System.out.println(realPath);
        // /part3
        System.out.println(context.getContextPath());
        // java.io.ByteArrayInputStream@72c69f82
